Projeto que Organiza os arquivos de forma automática

É um projeto simples, mas útil no dia a dia. Sendo uma automação para organizar arquivos com Python. A ideia desse projeto é que você consiga separar arquivos do mesmo tipo em pastas.
Então pode separar imagens, arquivos PDF, arquivos csv... 
